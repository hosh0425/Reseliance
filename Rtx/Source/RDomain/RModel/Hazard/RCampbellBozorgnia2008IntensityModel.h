#ifndef RCampbellBozorgnia2008IntensityModel_H	
#define RCampbellBozorgnia2008IntensityModel_H	
...
class RCampbellBozorgnia2008IntensityModel : public RModel	
{	
	Q_OBJECT
...
public:	
	RCampbellBozorgnia2008IntensityModel(QObject *parent, QString name);
	~RCampbellBozorgnia2008IntensityModel();

	enum RFaultType{StrikeSlip, NormalSlip, ReverseSlip};
	enum RResponseType{Sa, PGA, PGV ,PGD, CAV};
...
#endif // RCampbellBozorgnia2008IntensityModel_H	