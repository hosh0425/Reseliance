#ifndef RMatlabModel_H
#define RMatlabModel_H

#include "RExternalSoftwareModel.h"

class RMatlabModel : public RExternalSoftwareModel
{
	Q_OBJECT
	...
	Q_PROPERTY(bool MinimizeMatlabWindow READ getMinimizeMatlabWindow WRITE setMinimizeMatlabWindow USER true)

public:
	RMatlabModel(QObject *parent, QString name);
	~RMatlabModel();
	...
	bool getMinimizeMatlabWindow() const;
	void setMinimizeMatlabWindow(bool value);
...
private:
	...
	bool theMinimizeMatlabWindow;

};

#endif // RMatlabModel_H
