...
//gsl_matrix * STrussElement::theGlobalStiffnessMatrix;
//gsl_vector * STrussElement::theGlobalLoadVector;
//gsl_vector * STrussElement::theSectionResponseInGlobalXYZ;


STrussElement::STrussElement(QObject *parent, QString &name)
...
QObject * STrussElement::getSection() const
{
        return theSection;
}
void STrussElement::setSection(QObject *value)
{
...
QObject * STrussElement::getNode1() const
{
        return theNode1;
}
void STrussElement::setNode1(QObject *value)
{
...
QObject * STrussElement::getNode2() const
{
        return theNode2;
}
void STrussElement::setNode2(QObject *value)
{
...
double STrussElement::getAxialForce() const
{
...
double STrussElement::getAxialStress() const
{
...
int STrussElement::getNumNodes()
{
        return 2;
}

QObject * STrussElement::getNode(int i) const
{
        if (i==0) {
                return theNode1;
        }
...
QString STrussElement::getGeometricStiffness() const
{
        return theGeometricStiffness;
}

void STrussElement::setGeometricStiffness(QString value)
{
...
gsl_matrix * STrussElement::getGlobalStiffnessMatrix()
{
...
gsl_vector * STrussElement::getGlobalLoadVector()
{
...
int STrussElement::updateResponse()
{
...
int STrussElement::updateStructure()
{
...
int STrussElement::getLocalStiffnessMatrix(gsl_matrix *Klocal)
{
...
gsl_vector * STrussElement::getSectionResponseInGlobalXYZ()
{
...
bool STrussElement::canBeRunParallelly() {
	return false;
}
