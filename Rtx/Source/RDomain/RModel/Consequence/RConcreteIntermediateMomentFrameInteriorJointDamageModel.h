#ifndef RConcreteIntermediateMomentFrameInteriorJointDamageModel_H	
#define RConcreteIntermediateMomentFrameInteriorJointDamageModel_H	
...
class RConcreteIntermediateMomentFrameInteriorJointDamageModel : public RModel	
{	
	Q_OBJECT
...
public:	
	RConcreteIntermediateMomentFrameInteriorJointDamageModel(QObject *parent, QString name);
...
private:	
	...
	// Declare responses
	RResponse *theRCIMFDamageRatio;
	
};	
	
#endif // RConcreteIntermediateMomentFrameInteriorJointDamageModel_H	
